...
namespace Orchardization
{
    ...
    public class TypeSettingsGeneratorFactory : CodeGeneratorFactory
    {
        ...
        {
            return new TypeSettingsGenerator(context, Information);
        }
